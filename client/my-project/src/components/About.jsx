...
function About() {
  return (
    <>
      <div id="about" className="bg-blue-800 text-white">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start bg-white rounded-lg shadow-lg p-6 mt-8 space-y-6 md:space-y-0 md:space-x-6">
            ...
            <div className="flex-1">
              <p className="text-md md:text-lg font-bold font-serif text-blue-800">
                Uche Juan Augustine is a trained Petroleum Engineer and the Africa Sales Director of Unicat Catalyst in
                the United States.
                <br />
                <br />
                He's the CEO of Juan Consulting which focuses on training, consulting and building executives, staff and
                youths around human capital development, leadership and relationship management.
                <br />
                <br />
                ...
                <br />
                <br />
                He is a sought-after speaker nationally and globally. His national summits attract over 2000 audience.
                <br />
                <br />
             He's an admirable and exceptional relationship, leadership and personal development expert and clergy
                ...
                <br />
                <br />
                As a Relationship Coach & Expert, he trains, consults, and guides both singles and married individuals
                on how to attract and be the right partner and how to build a happy relationship and home.
                <br />
                <br />

...
let x = 0;
const Ques = Question[x].question[x];
...
<div className='py-36 flex flex-col justify-center items-center'>
	<div className='bg-white rounded-md pb-2 shadow-lg'>
		<h1  className='bg-blue-700 px-4 py-3 text-white font-bold rounded-t-md'> {Ques}  </h1>
		<div className='flex flex-col w-full gap-3 pt-3 pb-2 px-2 relative'>
			<div className='relative w-full h-8'>
				<input type='checkbox' onClick={display}  id='Yes'   className='appearance-none rounded-lg bg-gray-100 cursor-pointer h-full w-full 
                    checked:bg-blue-400 transition-all duration-200   checked:hover:bg-black-400 hover:bg-blue-800 peer'></input>
				<label htmlFor='tennis' className='  hover:text-white font-bold absolute top-[50%] left-3 text-gray-400   -translate-y-[50%]
			...
			<div className='relative w-full  h-8'>
				<input type='checkbox' id='No' className='appearance-none rounded-lg bg-gray-100 cursor-pointer h-full w-full 
                    checked:bg-teal-400 transition-all duration-200 checked:hover:bg-black-400 font-bold hover:bg-blue-800  peer'></input>
				<label htmlFor='rugby' className='  hover:text-white font-bold absolute top-[50%] left-3 text-gray-400   -translate-y-[50%]
                     peer-checked:text-gray-100 transition-all duration-200 select-none
                '>No</label>
			</div>
...
<div className=" max-w-lg p-11 container flex justify-center mx-auto">
  <div className="flex flex-row mx-auto">
    ...
    <button   type="button"  className="bg-black text-white rounded-r-md py-2 border-l border-gray-200 hover:bg-blue-700 hover:text-white px-3">
      <div className="flex flex-row align-middle">
        <a href="/survey/Next" onClick={Next} className="mr-2">Next</a>
